#!/usr/bin/env python3
"""Plot RRAM Post-Layout Mixed-Signal Co-Simulation Results"""
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
data = np.loadtxt('rram_cosim_postlayout.csv')
...
fig.suptitle('RRAM Post-Layout Mixed-Signal Co-Simulation\n'
             'd_cosim Controller + Layout-Extracted WL Driver + RRAM 4x4 + Sense Amplifier (Closed Loop)',
...
plt.tight_layout()
plt.savefig('rram_cosim_postlayout.png', dpi=150, bbox_inches='tight')
print("Saved: rram_cosim_postlayout.png")
